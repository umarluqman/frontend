    ...
    return (
        <div>
                ...
                <div className="flex dark:text-white text-3xl font-bold mb-6 mt-4">
                    <div className="transactionInfoItem z-50">
                        <div className="slippage text-steel-400 text-sm dark:text-white flex">
                            <span className="mr-2 flex dark:text-white text-base sm:text-3xl">Deposit your Stablecoins into Liquidity Pools</span><span className><div className="dark:hidden flex">
          ...
          " />
                        ...
                        <div className="hidden font-base" style={{ position: 'absolute', inset: '0px auto auto 0px', margin: 0, transform: 'translate(961px, 164px)' }} data-popper-placement="bottom" data-popper-reference-hidden data-popper-escaped>
                            <div>
              ...
              earn high yields.
                ...
                <div className="grid grid-cols-auto sm:grid-cols-3 gap-3">
                    <a href="/Deposit/ust-pools-lps"><div className="pool-item dark:bg-dark-700 dark:border-dark-700 bg-white rounded-lg p-8  hover:border ">
                        <div className="flex justify-center pt-2 pb-2">
                            <div style={{ display: 'inline-block', maxWidth: '100%', overflow: 'hidden', position: 'relative', boxSizing: 'border-box', margin: 0 }}>
                                ...
                                <img src="/_next/image?url=%2Fimages%2Ficons%2Fust-pool.png&w=128&q=75" decoding="async" style={{ visibility: 'inherit', position: 'absolute', inset: 0, boxSizing: 'border-box', padding: 0, border: 'none', margin: 'auto', display: 'block', width: 0, height: 0, minWidth: '100%', maxWidth: '100%', minHeight: '100%', maxHeight: '100%' }} srcSet="
          /_next/image?url=%2Fimages%2Ficons%2Fust-pool.png&w=64&q=75  1x,
          /_next/image?url=%2Fimages%2Ficons%2Fust-pool.png&w=128&q=75 2x
        " />
                            </div>
                        </div>
                            ...
                            <div className="info-tvl-panel p-6 lg:py-8 text-white">
                                <div className="text-center">
                                    ...
                                    <div className="text-4xl sm:text-7xl font-bold my-10">
                                        <span className="sm:mr-3 mr-0">$</span>118,343,866
            </div>
                                </div>
                                <div className="text-center">
